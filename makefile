...
SRCS=main.c bup_header.c util.c backends/backend.c backends/saturn.c backends/satiator.c backends/cd.c backends/actionreplay.c backends/sat.c md5/md5.c backends/satiator/satiator.c backends/satiator/cd.c backends/mode.c backends/vcd_card.c
